...
use sp_runtime::{
	...
	traits::{
		...
		SaturatedConversion, One, Verify, IdentifyAccount
	},
...
/// Configure the pallet-quantumfusion in pallets/quantumfusion.
impl pallet_quantumfusion::Config for Runtime {
	type RuntimeEvent = RuntimeEvent;
...
impl pallet_offchaingate::Config for Runtime {
	...
	type AuthorityId = pallet_offchaingate::crypto::TestAuthId;
}
